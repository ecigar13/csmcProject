...
abstract class Session implements ModifiableInterface {
    ...
    public function __construct(SessionType $type, string $topic, string $description, string $studentInstructions, string $mentorInstructions, bool $graded, bool $numericGrade) {
	$this->topic = $topic;
