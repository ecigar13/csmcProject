...
class ClaimShiftOccurrence extends AttendanceOccurrence
{
     ...
     * @ORM\JoinColumn(name="covering_for", referencedColumnName="id")
     */
    private $coveringFor;

    public function __construct(User $subject, \DateTime $shiftDateTime, User $coveringFor, float $points = null,
     ...
     * @return User
     */
    public function getCoveringFor()
    {
        return $this->coveringFor;
    }
}